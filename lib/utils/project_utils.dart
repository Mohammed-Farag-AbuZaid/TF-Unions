...
List<ProjectUtils> upcomingProjectUtils = [
  ProjectUtils(
    ...
    title: 'STEM Union',
    description: 'This is a sub organization project that focuses on STEM education .',
  ...
  ProjectUtils(
   ...
   ProjectUtils(
    ...
    title: 'UV Journal',
    description: 'this will be writing platform to help ace thier academic writing',
    webLink: 'https://www.example.com/project2',
   ...
   ProjectUtils(
    ...
    title: 'APC English',
    description: 'This will be a cross patform app to help students ace thier english',
    webLink: 'https://www.example.com/project2',
